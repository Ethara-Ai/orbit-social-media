...
// Mock icons
vi.mock('../icons', () => ({
  Heart: ({ className }) => <svg data-testid="heart-icon" className={className} />,
}));
...
describe('FeaturedPostCard', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render the post image', () => {
      ...
      const postImage = images.find((img) => img.getAttribute('alt') === 'Amazing Featured Post');
    ...
    it('should render the user avatar', () => {
      render(<FeaturedPostCard {...defaultProps} />);
      const images = screen.getAllByRole('img');
      const avatarImage = images.find((img) => img.getAttribute('alt') === 'John Doe');
  ...
  describe('edge cases', () => {
    ...
    it('should handle long user name', () => {
      ...
      expect(screen.getByText('Alexander Bartholomew Wellington III')).toBeInTheDocument();
    });
    ...
    it('should handle special characters in title', () => {
      ...
      render(<FeaturedPostCard {...defaultProps} post={postWithSpecialChars} />);
