...
describe("UserProfileCard", () => {
  ...
  describe("non-animated mode", () => {
    it("should render regular div when animated is false", () => {
      const { container } = render(
        <UserProfileCard {...defaultProps} animated={false} />,
      );
  ...
  describe("edge cases", () => {
    it("should handle long user name", () => {
      ...
      expect(
        screen.getByText("This Is A Very Long User Name"),
      ).toBeInTheDocument();
    });
    ...
    it("should handle long profession", () => {
      ...
      expect(
        screen.getByText("Senior Principal Staff Software Engineer Lead"),
      ).toBeInTheDocument();
    });
