...
describe('ConnectionsList', () => {
  ...
  describe('toggle behavior', () => {
    it('should call setShowFriends when header is clicked', () => {
      ...
      render(<ConnectionsList {...defaultProps} setShowFriends={setShowFriends} />);
    ...
    it('should toggle from true to false when clicked', () => {
      const setShowFriends = vi.fn();
      render(
        <ConnectionsList {...defaultProps} showFriends={true} setShowFriends={setShowFriends} />
      );
    ...
    it('should toggle from false to true when clicked', () => {
      const setShowFriends = vi.fn();
      render(
        <ConnectionsList {...defaultProps} showFriends={false} setShowFriends={setShowFriends} />
      );
  ...
  describe('friend click handling', () => {
    it('should call onFriendClick when a friend is clicked', () => {
      ...
      render(
        <ConnectionsList {...defaultProps} showFriends={true} onFriendClick={onFriendClick} />
      );
    ...
    it('should not throw when onFriendClick is not provided', () => {
      expect(() => {
        render(<ConnectionsList {...defaultProps} showFriends={true} onFriendClick={undefined} />);
        fireEvent.click(screen.getByText('Alice Smith'));
      }).not.toThrow();
    });
  });
  ...
  describe('friend item styling', () => {
    it('should have flex layout on friend item', () => {
      const { container } = render(<ConnectionsList {...defaultProps} showFriends={true} />);
      const friendItems = container.querySelectorAll('.flex.items-center.gap-2');
  ...
  describe('edge cases', () => {
    it('should handle empty friends list', () => {
      render(<ConnectionsList {...defaultProps} friends={[]} showFriends={true} />);
      expect(screen.getByText('Connections')).toBeInTheDocument();
      expect(screen.getByText('0')).toBeInTheDocument();
    });
    ...
    it('should handle long friend names', () => {
      ...
      render(<ConnectionsList {...defaultProps} friends={longNameFriend} showFriends={true} />);
      expect(
    ...
    it('should handle special characters in friend names', () => {
      ...
      render(<ConnectionsList {...defaultProps} friends={specialNameFriend} showFriends={true} />);
    ...
    it('should handle emoji in friend names', () => {
      ...
      render(<ConnectionsList {...defaultProps} friends={emojiFriend} showFriends={true} />);
    ...
    it('should handle missing avatar gracefully', () => {
      ...
      expect(() => {
        render(<ConnectionsList {...defaultProps} friends={noAvatarFriend} showFriends={true} />);
      }).not.toThrow();
    });
    ...
    it('should handle undefined lastSeen for offline friend', () => {
      ...
      expect(() => {
        render(<ConnectionsList {...defaultProps} friends={noLastSeenFriend} showFriends={true} />);
      }).not.toThrow();
    });
  });
  ...
  describe('avatar configuration', () => {
    ...
    it('should pass correct src to Avatar', () => {
      ...
      expect(avatars[2]).toHaveAttribute('src', 'https://example.com/carol.jpg');
    });
