...
const ConnectionsHeader = ({ friendsCount, showFriends, setShowFriends }) => {
  return (
    <motion.button
      ...
      className="w-full flex items-center justify-between px-4 py-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer"
...
const ConnectionItem = ({ friend, index, onClick }) => {
  ...
  return (
    <motion.div
      className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer mx-2"
...
export { ConnectionsHeader, ConnectionItem };
