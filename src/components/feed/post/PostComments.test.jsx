...
describe("PostComments", () => {
  ...
  describe("rendering", () => {
    ...
    it("should not render comments from other posts", () => {
      render(<PostComments {...defaultProps} />);
      expect(
        screen.queryByText("Different post comment"),
    ...
    it("should render current user avatar", () => {
      ...
      const currentUserAvatar = avatars.find(
        (a) => a.getAttribute("alt") === "Current User",
      );
  ...
  describe("submit button", () => {
    ...
    it("should be disabled when newComment is only whitespace", () => {
      render(
        <PostComments {...defaultProps} newComment={{ "post-1": "   " }} />,
      );
      const button = screen.getByRole("button", { name: "Post" });
      expect(button).toBeDisabled();
    });
  ...
  describe("comment item rendering", () => {
    ...
    it("should render comment user avatars", () => {
      render(<PostComments {...defaultProps} />);
      const avatars = screen.getAllByTestId("avatar");
      const johnAvatar = avatars.find(
        (a) => a.getAttribute("alt") === "John Doe",
      );
      const janeAvatar = avatars.find(
        (a) => a.getAttribute("alt") === "Jane Smith",
      );
  ...
  describe("edge cases", () => {
    ...
    it("should handle long comment content", () => {
      ...
      render(
        <PostComments
          {...defaultProps}
          comments={[...mockComments, longComment]}
        />,
      );
    ...
    it("should handle special characters in comment", () => {
      ...
      render(
        <PostComments
          {...defaultProps}
          comments={[...mockComments, specialComment]}
        />,
      );
      expect(
        screen.getByText("Comment with <special> & characters!"),
      ).toBeInTheDocument();
    });
  ...
  describe("avatar props", () => {
    ...
    it("should pass correct src to current user avatar", () => {
      ...
      expect(currentUserAvatar).toHaveAttribute(
        "src",
