...
describe("ChatHeader", () => {
  ...
  describe("online status display", () => {
    ...
    it("should display last seen when user is offline", () => {
      ...
      render(
        <ChatHeader {...defaultProps} conversation={offlineConversation} />,
      );
  ...
  describe("back button", () => {
    it("should call onBack when back button is clicked", () => {
      ...
      const { container } = render(
        <ChatHeader {...defaultProps} onBack={onBack} />,
      );
      const backButton = container.querySelector(".sm\\:hidden");
  ...
  describe("dropdown menu", () => {
    it("should call setShowDropdown when more button is clicked", () => {
      ...
      render(
        <ChatHeader {...defaultProps} setShowDropdown={setShowDropdown} />,
      );
      const moreButton = screen.getByTestId(
  ...
  describe("edge cases", () => {
    it("should handle long user name with truncate", () => {
      ...
      render(
        <ChatHeader {...defaultProps} conversation={longNameConversation} />,
      );
    ...
    it("should handle missing avatar gracefully", () => {
      ...
      expect(() => {
        render(
          <ChatHeader {...defaultProps} conversation={noAvatarConversation} />,
        );
      }).not.toThrow();
    });
    ...
    it("should handle undefined lastSeen when offline", () => {
      ...
      expect(() => {
        render(
          <ChatHeader
            {...defaultProps}
            conversation={noLastSeenConversation}
          />,
        );
      }).not.toThrow();
    });
  ...
  describe("dropdown styling", () => {
    it("should have absolute positioning when open", () => {
      const { container } = render(
        <ChatHeader {...defaultProps} showDropdown={true} />,
      );
