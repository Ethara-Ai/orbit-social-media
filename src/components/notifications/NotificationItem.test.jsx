...
describe('NotificationItem', () => {
  ...
  describe('notification types', () => {
    ...
    it('should render comment notification with blue icon background', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={commentNotification} />);
    ...
    it('should render follow notification with emerald icon background', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={followNotification} />);
    ...
    it('should render mention notification with orange icon background', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={mentionNotification} />);
    ...
    it('should render friend_request notification with purple icon background', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={friendRequestNotification} />);
    ...
    it('should render unknown notification type with slate icon background', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={unknownNotification} />);
  ...
  describe('notification content', () => {
    ...
    it('should display message text', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={notification} />);
  ...
  describe('edge cases', () => {
    ...
    it('should handle long user name', () => {
      ...
      render(<NotificationItem {...defaultProps} notification={notification} />);
      expect(
        screen.getByText('A Very Long User Name That Might Overflow The Container')
      ).toBeInTheDocument();
    });
