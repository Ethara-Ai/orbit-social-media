...
describe('EmptyState', () => {
  ...
  describe('icon', () => {
    ...
    it('should apply custom icon className when provided', () => {
      render(<EmptyState icon={MockIcon} iconClassName="w-12 h-12 text-red-500" />);
      const icon = screen.getByTestId('mock-icon');
  ...
  describe('combined props', () => {
    ...
    it('should work with icon and action only', () => {
      const handleAction = vi.fn();
      render(<EmptyState icon={MockIcon} action={handleAction} actionLabel="Just Action" />);
  ...
  describe('accessibility', () => {
    ...
    it('should have clickable button', () => {
      const handleAction = vi.fn();
      render(<EmptyState action={handleAction} actionLabel="Accessible Action" />);
      const button = screen.getByRole('button');
  ...
  describe('transitions', () => {
    ...
    it('should have transition classes on button', () => {
      const handleAction = vi.fn();
      render(<EmptyState action={handleAction} actionLabel="Transition Button" />);
      const button = screen.getByRole('button');
