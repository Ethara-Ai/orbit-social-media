...
describe("LoadingScreen", () => {
  describe("rendering", () => {
    ...
    it("should render the tagline", () => {
      render(<LoadingScreen />);
      expect(
        screen.getByText("Connect • Discover • Thrive"),
      ).toBeInTheDocument();
    });
  ...
  describe("loading indicator", () => {
    it("should render three loading dots", () => {
      ...
      const loadingDots = container.querySelectorAll(
        ".bg-orange-500.rounded-full.w-3.h-3",
      );
  ...
  describe("background", () => {
    ...
    it("should have rounded background elements", () => {
      ...
      const roundedElements =
        patternContainer.querySelectorAll(".rounded-full");
  ...
  describe("logo container", () => {
    ...
    it("should have flex centering on logo box", () => {
      const { container } = render(<LoadingScreen />);
      const logoBox = container.querySelector(
